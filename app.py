...
st.set_page_config(page_title="Gait Analysis System", layout="wide")
...
if uploaded_file is not None:
    ...
    try:
        ...
        while cap.isOpened():
            ...
            if results[0].keypoints is not None and len(results[0].keypoints.xy) > 0:
                ...
                if len(keypoints) > 16:
                    ...
                    total_elapsed_time = frame_count / fps
            ...
            frame_placeholder.image(image_rgb, channels="RGB", width=320)
        ...
        st.error(f"Runtime execution error: {run_error}")
